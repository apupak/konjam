...
# Basic Phonetic -> Tamil Transliteration Table
rules = {
...
# but Google TTS kn-IN is very smart; if it sees basic Tamil characters, it will pronounce it correctly.

def simple_transliterate(phonetic):
    # This is a very rough best-effort fallback
    # In reality, the TAMIL_MAPPING already covers the important 150+ ones.
    # We just need to give Google *something* in Tamil script for the rest.
...
# Let's just find the 129 silent ones and map them to their fallback word but in Tamil

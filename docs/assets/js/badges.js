...
const BADGE_DEFINITIONS = {
    'first_lesson': {
        title: 'Filter Kaapi First',
        description: 'Finish your very first lesson.',
        emoji: '☕'
    },
    'meter_haaki_pro': {
        title: 'Auto Rickshaw Negotiator',
        description: 'Successfully negotiate a fair fare in Meter Podu.',
        emoji: '🛺'
    },
    'suffix_scientist': {
    ...
    'adjust_maadi_master': {
        ...
        description: 'Navigate complex logistics in Adjust Pannunga.',
        emoji: '🔧'
    },
    'local_insider': {
        title: 'Local Insider',
    ...
    'proper_local': {
        title: 'Proper Local',
        description: 'Achieve the maximum rank on Konjam.',
        emoji: '👑'
    },
    'regular_giraki': {

...
export function logActivity(points = 1) {
    try {
        ...
        console.log(`[KONJAM] Activity logged for ${today}: +${points} (Total: ${log[today]})`);
    } catch (e) {
        console.error("Failed to log KONJAM activity:", e);
    }
}
...
export function getActivityLog() {
    try {
        ...
        console.error("Failed to parse KONJAM activity log:", e);
    }
    return {};
}
...
window.konjamGetActivityLog = getActivityLog;

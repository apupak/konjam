...
**Objective**: Act as a Senior Game Designer and Lead Linguist for "Konjam," a project teaching Chennai Tamil through real-world street interactions. Your task is to design a series of deep, intricate branching dialogue levels for the "Auto-Rickshaw Protocol" game.
...
2.  **Choice B (Tamil - Polite/Local)**: Earns **Respect (+10 to +25)** and potentially lowers **Money Cost (-10%)**. Uses correct polite imperatives or local Chennai slang.
3.  **Choice C (Tamil - Mix/Attempt)**: Mixed results. Uses Tamil but maybe slightly incorrect or overly formal. Small **Respect** gain, neutral cost.
...
**Tone**: Urban, authentic, gritty-but-helpful. Capture the unique "Rickshaw Logic" of Chennai.

**Linguistic Requirement**: All Tamil options should be provided in **Latin transliteration** (e.g., "Hogona?") with the **English translation** in parentheses.

...
> *   **Primary Accent:** Vibrant 'Auto-Rickshaw' Yellow (#FFD700 or similar bright yellow) for titles, key highlights, and primary buttons/shapes.
> *   **Secondary Accent:** Crimson/Bright Red for warnings, urgent tips, or secondary highlights.
> *   **Text:** Crisp white or light slate gray for high readability against the dark backgrounds.
> 
> **2. UI & Aesthetic Elements (Glassmorphism):**
> *   Use 'Glassmorphism' effects: UI panels, text boxes, and vocabulary cards should look like frosted glass—translucent dark backgrounds with a slight blur, outlined by a very subtle, thin white border (e.g., 10% opacity white).
> *   Shapes should have distinctly rounded corners (16px radius) to feel modern and friendly, yet sleek.
> *   Use soft, subtle drop shadows behind the glass panels to create depth.
> 
> **3. Typography:**
> *   Use clear, modern sans-serif fonts (like 'Inter' or 'Roboto') for the main text. 
